...
import { proxyExistUsuario, proxyValidarUsuarios, proxyValidateColeccion } from "../middleware/proxyIngresoU.js";
const AppIngresoUsuario = Router();
let db = await con();

let tokens_Api = db.collection("tokens_Api");

AppIngresoUsuario.get('/', limitPColecciones(235, "IngresoUsuario"), proxyValidarUsuarios, proxyExistUsuario, proxyValidateColeccion, async (req, res) =>{
