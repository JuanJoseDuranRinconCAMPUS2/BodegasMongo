...
import { proxyUsuarios, proxyCrearUsuarios } from "../middleware/proxyCrearUsuario.js";
...
AppCrearUsuario.post('/', limitPColecciones(235, "CrearUsuario"),proxyCrearUsuarios,  proxyUsuarios, async (req, res) =>{
